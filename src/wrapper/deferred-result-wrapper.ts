 ...
 */
export class 常用直接形式接口封装<
  路径类型 extends 接口路径类型,
  方法类型 extends 接口方法类型,
  逻辑类型 extends 接口逻辑Base<any, 空对象, z.infer<接口错误形式Zod>, { data: z.infer<接口正确形式Zod> }, any, any>,
...
> extends 接口<
  ...
  接口正确形式Zod,
  直接形式转换器<接口正确形式Zod, 获得接口逻辑错误类型<逻辑类型>, 获得接口逻辑正确类型<逻辑类型>>,
