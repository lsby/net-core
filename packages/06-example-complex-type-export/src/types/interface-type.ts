...
export type InterfaceType = [{ path: "/api/structure/add"; method: "post"; input: { data: { type: "object"; properties: Record<string, JSONSchema>; required?: string[] | undefined; definitions?: Record<string, JSONSchema> | undefined; } | { type: "object"; $ref?: `http://${string}` | `https://${string}` | undefined; }; }; errorOutput: { status: "fail"; data: never; }; successOutput: { status: "success"; data: {}; }; wsOutput: {}; wsInput: {}; }]